...
var store = new _vuex.default.Store({
  ...
  actions: {
    ...
    data) {var commit = _ref.commit,state = _ref.state,dispatch = _ref.dispatch;var

      accessToken =

      data.accessToken,callback = data.callback;

      (0, _interface.accesstoken)({
        'accesstoken': accessToken }).
      then(function (res) {
        if (res.statusCode === 200 && res.data.success) {
          (0, _interface.user_detail)(res.data.loginname).then(function (res) {
    ...
    // 获取用户收藏主题
    getTopicInfo: function getTopicInfo(_ref2,

    data) {var commit = _ref2.commit;
      (0, _interface.topic_collect)(data).then(function (res) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/home/index": { "navigationBarTitleText": "CNode" }, "pages/message/index": { "navigationBarTitleText": "消息" }, "pages/mine/index": { "navigationBarTitleText": "我的" }, "pages/detail/detail": { "navigationBarTitleText": "详情" }, "pages/login/index": { "navigationBarTitleText": "登录" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "CNode", "navigationBarBackgroundColor": "#457bbe", "backgroundColor": "#F8F8F8" } };exports.default = _default;
